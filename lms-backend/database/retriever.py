...
class Retriever:
    ...
    def filtered_hybrid_search(
        ...
        print("filtered hybrid search resp", response)
    ...
    def filtered_search(
        ...
        print("filtered search resp", response)
        return response.data
    ...
    def get_document_ids_by_urls(self, urls: List[str]) -> List[int]:
        ...
        print("get doc ids by urls", response)
        return response.data
    ...
    def hybrid_search(
        ...
        print("hybrid search resp", response)
        return response.data
    ...
    def search_chunks(
        ...
        print("search chunks resp", response)
        return response.data
    ...
    def search_documents(
        ...
        print("search docs resp", response)
        return response.data